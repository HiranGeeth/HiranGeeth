...
| [🔍 Fiber-Optic-Attenuation-Limited-Length-Optimization](https://github.com/HiranGeeth/Fiber_Attenuation_OptiPerformer_Simulation)) |Determined optimal attenuation-limited length (118.6 km) for 2.5 Gb/s G.652 SMF, achieving Q=6 (BER=10⁻⁹) via iterative OptiPerformer simulation — 2.4 km shorter than theoretical prediction | OptiPerformer, Fiber, Power Budget Analysis |
