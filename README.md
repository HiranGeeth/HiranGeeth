...
|--------|-------------|------------|
| [🤖 Fully-Automated-Robot-Arm](https://github.com/HiranGeeth/Robot-Arm) | JS frontend for controlling a robotic arm via ESP32 backend along with other functions| JavaScript, HTML, CSS, C++ |
